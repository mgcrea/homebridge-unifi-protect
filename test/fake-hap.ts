 ...
 * outside a real bridge, and it is where a plugin ends up displaying a
 * fabricated 0 °C for every device. The fake records characteristic values and
...
export class FakeService {
  ...
  setPrimaryService(value: boolean): this {
    this.primary = value;
    return this;
  }
